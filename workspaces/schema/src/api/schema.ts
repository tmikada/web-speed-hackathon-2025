...
export const getTimetableByIdRequestParams = Compile(Valibot(openapiSchema.getTimetableByIdRequestParams));
export const getTimetableByIdRequestQuery = Compile(Valibot(openapiSchema.getTimetableByIdRequestQuery));
export const getTimetableByIdResponse = Compile(Valibot(openapiSchema.getTimetableByIdResponse));
